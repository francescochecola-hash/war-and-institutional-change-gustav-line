...
#
# Script: 07_select_gagliarducci_et_al_data.R
...
file_wow <- here("data", "processed", "import", "data_final_wow.rds")
...
out_path <- here("data", "processed", "select", "gagliarducci_et_al_selected.rds")
