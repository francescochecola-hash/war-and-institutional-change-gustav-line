...
file_sample <- "data/processed/import/replication_data_sample_analysis.rds"
file_additional <- "data/processed/import/replication_data_additional_data.rds"
...
out_path <- "data/processed/select/fontana_et_al_selected.rds"
